...
import (
	...
	"github.com/sugoto/gameboy-emu/internal/audio"
	"github.com/sugoto/gameboy-emu/internal/video"
)
...
func (cs *cpuState) IsCGBMode() bool { return cs.CGBMode }
func (cs *cpuState) SetVBlankIRQ()   { cs.VBlankIRQ = true }
func (cs *cpuState) SetLCDStatIRQ()  { cs.LCDStatIRQ = true }
func (cs *cpuState) RunHblankDMA()   { cs.runHblankDMA() }
...
func (cs *cpuState) GetSoundBufferInfo() SoundBufferInfo {
	return SoundBufferInfo{
		IsValid:  true,
		UsedSize: int(cs.APU.BufferSize()),
	}
}
